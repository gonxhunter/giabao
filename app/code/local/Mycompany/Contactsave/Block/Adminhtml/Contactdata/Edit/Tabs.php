...
class Mycompany_Contactsave_Block_Adminhtml_Contactdata_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('mycompany_contactsave')->__('Báo lỗi sản phẩm'));
    }
    ...
    protected function _beforeToHtml()
    {
        $this->addTab(
            'form_contactdata',
            array(
                'label'   => Mage::helper('mycompany_contactsave')->__('Báo lỗi sản phẩm'),
                'title'   => Mage::helper('mycompany_contactsave')->__('Báo lỗi sản phẩm'),
